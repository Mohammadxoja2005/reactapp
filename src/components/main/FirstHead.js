              ...
              <div className="row align-items-center">
                <div className="col-lg-4 col-md-6 text-center text-md-start">
                  <div className="header-top-social-Links">
                    <span className="follow-text mr-15" style={{color: "black"}}>Follow Us:</span>
                    <Social /> 
                  </div>
                </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            ...
            <div className="navigation-top-search-area mt-md-25 mt-sm-25">
              <div className="row align-items-center justify-content-between">
                ...
                <div className="mobile-menu-wrapper d-block d-lg-none order-3">
                    <div className="mobile-menu animate__animated  animate__bounce">
