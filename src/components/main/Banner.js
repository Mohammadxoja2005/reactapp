...
export default function Banner() { 
  ...
  const fakeData = [
    { 
      title: "Hello world fdafdsfdshfkjdshfksdhfk", 
      description: "This is line which I wrote a lot to you but you didn't read it.", 
      avaibility: 120,
      discount: 0, 
      price: 100,
      // product: "Оффис", 
      imgUrl: ["assets/img/products/inner-big2-4.webp", "assets/img/products/inner-big2-4.webp"], 
    },   
    { 
      title: "Hello", 
      description: "This is line which I wrote a lot to you but you didn't read it.", 
  ...
  whiteSpace: "pre-line",  }}>
                      ...
                      {/* avaibility part */}
                        ...
                        <div className="product-availability__text mb-0 mt-10">
                          <div className="sold">Sold:1400</div>
                          <div className="remaining">Available:230</div>
                        </div> 
